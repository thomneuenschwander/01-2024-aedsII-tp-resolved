...
public class Q5 {
    ...
    static void selectionSort(Character[] characters) {
    ...
    public static void main(String[] args) {
        ...
        selectionSort(selectedCharactersArray);
    ...
    static Optional<Character> linearSearchByName(List<Character> characters, String name) {
